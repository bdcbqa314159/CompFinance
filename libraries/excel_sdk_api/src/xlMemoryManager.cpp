...
//              time.  Using a singleton class, the manager provides an
//              interface to C code into the manager.  The number of unique
//              pools starts as MEMORYPOOLS, defined in MemoryManager.h.  When a
//              new thread needs a pool, and the current set of pools are all
//              assigned, the number of pools increases by a factor of two.
//
