...
//  Helpers
NumericalParam xl2num(const double useSobol, const double seed1,
                      const double seed2, const double numPath,
...
extern "C" __declspec(dllexport) double xRestartThreadPool(double xNthread) {
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutDupire(
    //  model parameters
    double spot, FP12* spots, FP12* times, FP12* vols, double maxDt,
    LPXLOPER12 xid) {
  FreeAllTempMemory();
  ...
  if (spots->rows * spots->columns * times->rows * times->columns !=
...
xPutBlackScholes(double spot, double vol, double qSpot, double rate, double div,
                 LPXLOPER12 xid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutDLM(
    //  model parameters
    LPXLOPER12 assets, FP12* spots, FP12* atms, FP12* skews, double discRate,
    FP12* repoSpreads, FP12* divDates, FP12* divs, FP12* correl, double lambda,
    LPXLOPER12 xid) {
  FreeAllTempMemory();
  ...
  for (const auto& asset : vassets)
    if (asset.empty()) return TempErr12(xlerrNA);
  ...
  if (spots->rows * spots->columns != vnumassets ||
      ...
      divs->rows != divDates->rows || divs->columns != vnumassets ||
      divDates->columns != 1 || correl->rows != vnumassets ||
      correl->columns != vnumassets) {
    return TempErr12(xlerrNA);
  }
  ...
  //  Call and return
  putDisplaced(vassets, vspots, vatms, vskews, discRate, vspreads, vdivtimes,
               vdivs, vcorrel, lambda, id);

  return TempStr12(id);
}

extern "C" __declspec(dllexport) LPXLOPER12 xViewDLM(LPXLOPER12 xid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutEuropean(double strike,
                                                         double exerciseDate,
...
extern "C" __declspec(dllexport) LPXLOPER12
xPutBarrier(double strike, double barrier, double maturity, double monitorFreq,
            double smoothing, LPXLOPER12 xcallput, LPXLOPER12 xid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutContingent(double coupon,
                                                           double maturity,
                                                           double payFreq,
                                                           double smoothing,
                                                           LPXLOPER12 xid) {
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutEuropeans(FP12* maturities,
                                                          FP12* strikes,
                                                          LPXLOPER12 xid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutMultiStats(LPXLOPER12 assets,
                                                           FP12* fix, FP12* fwd,
                                                           LPXLOPER12 xid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutBaskets(LPXLOPER12 assets,
                                                        FP12* weights,
                                                        double maturity,
                                                        FP12* strikes,
                                                        LPXLOPER12 xid) {
...
extern "C" __declspec(dllexport) LPXLOPER12 xPutAutocall(
    LPXLOPER12 assets, FP12* refs, double maturity, double periods, double ko,
    double strike, double cpn, double smooth, LPXLOPER12 xid) {
  FreeAllTempMemory();
  ...
  //  Call and return
  putAutocall(vassets, vrefs, maturity, int(periods + EPS), ko, strike, cpn,
              smooth, id);
...
extern "C" __declspec(dllexport) LPXLOPER12 xPayoffIds(LPXLOPER12 xid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12 xParameters(LPXLOPER12 xid) {
  FreeAllTempMemory();
  ...
  transform(params.begin(), params.end(), paramsCopy.begin(),
            [](const double* p) { return *p; });

  return from_labelsAndNumbers(paramLabels, paramsCopy);
}

extern "C" __declspec(dllexport) LPXLOPER12 xValue(LPXLOPER12 modelid,
...
extern "C" __declspec(dllexport) LPXLOPER12
xValueTime(LPXLOPER12 modelid, LPXLOPER12 productid,
           //  numerical parameters
           double useSobol, double seed1, double seed2, double numPath,
           double parallel) {
  FreeAllTempMemory();
  ...
  try {
    ...
    for (int i = 0; i < results.values.size(); ++i)
      setNum(oper, results.values[i], i, 0);
...
extern "C" __declspec(dllexport) LPXLOPER12
xAADrisk(LPXLOPER12 modelid, LPXLOPER12 productid, LPXLOPER12 xRiskPayoff,
         //  numerical parameters
         double useSobol, double seed1, double seed2, double numPath,
         double parallel) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12
xAADriskAggregate(LPXLOPER12 modelid, LPXLOPER12 productid, LPXLOPER12 xPayoffs,
                  FP12* xNotionals,
                  //  numerical parameters
                  double useSobol, double seed1, double seed2, double numPath,
                  double parallel) {
...
extern "C" __declspec(dllexport) LPXLOPER12
xBumprisk(LPXLOPER12 modelid, LPXLOPER12 productid,
          //  numerical parameters
          double useSobol, double seed1, double seed2, double numPath,
          double parallel,
          //  display now or put in memory?
          double displayNow, LPXLOPER12 storeid) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) LPXLOPER12
xAADriskMulti(LPXLOPER12 modelid, LPXLOPER12 productid,
              //  numerical parameters
              double useSobol, double seed1, double seed2, double numPath,
              double parallel,
              //  display now or put in memory?
...
extern "C" __declspec(dllexport) LPXLOPER12 xDisplayRisk(LPXLOPER12 riskid,
  ...
  return from_labelledMatrix(results->params, riskIds, showRisks, "value",
                             showVals);
}

extern "C" __declspec(dllexport) LPXLOPER12 xDupireCalib(
    //  Merton market parameters
    const double spot, const double vol, const double jmpIntens,
    const double jmpAverage, const double jmpStd,
    //  Discretization
    FP12* spots, const double maxDs, FP12* times, const double maxDt) {
  FreeAllTempMemory();
  ...
  auto results = dupireCalib(vspots, maxDs, vtimes, maxDt, spot, vol, jmpIntens,
                             jmpAverage, jmpStd);
...
extern "C" __declspec(dllexport) LPXLOPER12 xDupireSuperbucket(
    //  Merton market parameters
    const double spot, const double vol, const double jmpIntens,
    const double jmpAverage, const double jmpStd,
    //  risk view
    FP12* strikes, FP12* mats,
    //  calibration
    FP12* spots, double maxDs, FP12* times, double maxDtVol,
    //  MC
    double maxDtSimul,
    //  product
    LPXLOPER12 productid, LPXLOPER12 xPayoffs, FP12* xNotionals,
    //  numerical parameters
    double useSobol, double seed1, double seed2, double numPath,
    double parallel,
    //  bump or AAD?
...

{
  ...
  try {
    auto results =
        bump < EPS
            ? dupireSuperbucket(spot, maxDtSimul, pid, notionals, vspots, maxDs,
                                vtimes, maxDtVol, vstrikes, vmats, vol,
                                jmpIntens, jmpAverage, jmpStd, num)
            : dupireSuperbucketBump(spot, maxDtSimul, pid, notionals, vspots,
                                    maxDs, vtimes, maxDtVol, vstrikes, vmats,
                                    vol, jmpIntens, jmpAverage, jmpStd, num);
    ...
    for (size_t i = 0; i < n; ++i) {
      ...
      for (size_t j = 0; j < m; ++j)
        setNum(oper, results.vega[i][j], 4 + i, 2 + j);
    }
...
extern "C" __declspec(dllexport) double xMerton(double spot, double vol,
                                                double mat, double strike,
                                                double intens, double meanJmp,
                                                double stdJmp) {
  return merton(spot, strike, vol, mat, intens, meanJmp, stdJmp);
}

extern "C" __declspec(dllexport) double xBarrierBlackScholes(
    double spot, double rate, double div, double vol, double mat, double strike,
    double barrier) {
  return BlackScholesKO(spot, rate, div, strike, barrier, mat, vol);
}

extern "C" __declspec(dllexport) double xToyDupireBarrierMc(
    //  model parameters
    double spot, FP12* spots, FP12* times, FP12* vols, double mat,
    double strike, double barrier, double paths, double steps, double epsilon,
    double useSobol, double seed1, double seed2) {
  FreeAllTempMemory();
  ...
  if (useSobol > 0.5)
    ...
    rng = make_unique<mrg32k3a>(seed1 > 0.5 ? int(seed1) : 12345,
                                seed2 > 0.5 ? int(seed2) : 123456);
  rng->init(int(steps));

  //  Call and return
  return toyDupireBarrierMc(spot, vspots, vtimes, vvols, mat, strike, barrier,
                            int(paths), int(steps), 100 * epsilon, *rng);
}

extern "C" __declspec(dllexport) LPXLOPER12 xToyDupireBarrierMcRisks(
    //  model parameters
    double spot, FP12* spots, FP12* times, FP12* vols, double mat,
    double strike, double barrier, double paths, double steps, double epsilon,
    double useSobol, double seed1, double seed2) {
  ...
  toyDupireBarrierMcRisks(spot, vspots, vtimes, vvols, mat, strike, barrier,
                          int(paths), int(steps), 100 * epsilon, *rng, price,
                          delta, vegas);
...
extern "C" __declspec(dllexport) LPXLOPER12 xSobolPoints(double numPoints,
                                                         double dimension,
                                                         double anti,
                                                         double skip) {
  FreeAllTempMemory();
...
extern "C" __declspec(dllexport) int xlAutoOpen(void) {
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           ...
           (LPXLOPER12)TempStr12(L"xRestartThreadPool"),
           (LPXLOPER12)TempStr12(L"numThreads"), (LPXLOPER12)TempStr12(L"1"),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL, (LPXLOPER12)TempStr12(L"xPutDLM"),
      (LPXLOPER12)TempStr12(L"QQK%K%K%BK%K%K%K%BQ"),
      (LPXLOPER12)TempStr12(L"xPutDLM"),
      (LPXLOPER12)TempStr12(L"assets, spots, atms, skews, DiscRate, "
                            L"RepoSpreads, divDates, divs, correl, lambda, id"),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL, (LPXLOPER12)TempStr12(L"xViewDLM"),
      (LPXLOPER12)TempStr12(L"QQ"), (LPXLOPER12)TempStr12(L"xViewDLM"),
      (LPXLOPER12)TempStr12(L"id"), (LPXLOPER12)TempStr12(L"1"),
      (LPXLOPER12)TempStr12(L"myOwnCppFunctions"), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(
          L"Displays the assets dynamics, alpha and beta, for debug and info"),
      (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(
      ...
      (LPXLOPER12)TempStr12(L"xPutEuropean"), (LPXLOPER12)TempStr12(L"QBBBQ"),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xPutBarrier"), (LPXLOPER12)TempStr12(L"QBBBBBQQ"),
      (LPXLOPER12)TempStr12(L"xPutBarrier"),
      (LPXLOPER12)TempStr12(L"strike, barrier, maturity, monitoringFreq, "
                            L"[smoothingFactor], [CallPut], id"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Initializes a European call in memory"),
      (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           ...
           (LPXLOPER12)TempStr12(L"xPutContingent"),
           (LPXLOPER12)TempStr12(
               L"coupon, maturity, payFreq, [smoothingFactor], id"),
           (LPXLOPER12)TempStr12(L"1"),
           (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
           (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
           (LPXLOPER12)TempStr12(L"Initializes a European call in memory"),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xPutEuropeans"), (LPXLOPER12)TempStr12(L"QK%K%Q"),
      (LPXLOPER12)TempStr12(L"xPutEuropeans"),
      (LPXLOPER12)TempStr12(L"maturities, strikes, id"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(
          L"Initializes a collection of European calls in memory"),
      (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           ...
           (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
           (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
           (LPXLOPER12)TempStr12(L"Initializes a ~product to compute "
                                 L"expectations and covariances in memory"),
           (LPXLOPER12)TempStr12(L""));

  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xPutBaskets"), (LPXLOPER12)TempStr12(L"QQK%BK%Q"),
      (LPXLOPER12)TempStr12(L"xPutBaskets"),
      (LPXLOPER12)TempStr12(L"assets, weights, maturity, strikes, id"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Initializes a ~product to compute expectations "
                            L"and covariances in memory"),
      (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(
      ...
      (LPXLOPER12)TempStr12(L"xPutAutocall"),
      (LPXLOPER12)TempStr12(
          L"assets, refSpots, maturity, periods, ko, strike, cpn, smooth, id"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Initializes a ~product to compute expectations "
                            L"and covariances in memory"),
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           (LPXLOPER12)TempStr12(L"xPayoffIds"), (LPXLOPER12)TempStr12(L"QQ"),
           (LPXLOPER12)TempStr12(L"xPayoffIds"), (LPXLOPER12)TempStr12(L"id"),
           (LPXLOPER12)TempStr12(L"1"),
           (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
           (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           (LPXLOPER12)TempStr12(L"xParameters"), (LPXLOPER12)TempStr12(L"QQ"),
           (LPXLOPER12)TempStr12(L"xParameters"), (LPXLOPER12)TempStr12(L"id"),
           (LPXLOPER12)TempStr12(L"1"),
           (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
           (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL, (LPXLOPER12)TempStr12(L"xValue"),
      (LPXLOPER12)TempStr12(L"QQQBBBBB"), (LPXLOPER12)TempStr12(L"xValue"),
      (LPXLOPER12)TempStr12(
          L"modelId, productId, useSobol, [seed1], [seed2], N, [Parallel]"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xValueTime"), (LPXLOPER12)TempStr12(L"QQQBBBBB"),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL, (LPXLOPER12)TempStr12(L"xAADrisk"),
      (LPXLOPER12)TempStr12(L"QQQQBBBBB"), (LPXLOPER12)TempStr12(L"xAADrisk"),
      (LPXLOPER12)TempStr12(L"modelId, productId, riskPayoff, useSobol, "
                            L"[seed1], [seed2], N, [Parallel]"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"AAD risk report"), (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(
      ...
      (LPXLOPER12)TempStr12(L"xAADriskAggregate"),
      (LPXLOPER12)TempStr12(L"modelId, productId, payoffs, notionals, "
                            L"useSobol, [seed1], [seed2], N, [Parallel]"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xBumprisk"), (LPXLOPER12)TempStr12(L"QQQBBBBBBQ"),
      (LPXLOPER12)TempStr12(L"xBumprisk"),
      (LPXLOPER12)TempStr12(L"modelId, productId, useSobol, [seed1], [seed2], "
                            L"N, [Parallel], [display?], [storeId]"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Bump risk report"), (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xDisplayRisk"), (LPXLOPER12)TempStr12(L"QQQ"),
      (LPXLOPER12)TempStr12(L"xDisplayRisk"),
      (LPXLOPER12)TempStr12(L"reportId, payoffId"), (LPXLOPER12)TempStr12(L"1"),
      (LPXLOPER12)TempStr12(L"myOwnCppFunctions"), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           ...
           (LPXLOPER12)TempStr12(L"xDupireSuperbucket"),
           (LPXLOPER12)TempStr12(
               L"spot, vol, jmpIt, jmpAve, jmpStd, RiskStrikes, riskMats, "
               L"volSpots, maxDs, volTimes, maxDtVol, maxDtSimul, productId, "
               L"payoffs, notionals, sobol, s1, s2, numPth, parallel, [bump?]"),
           (LPXLOPER12)TempStr12(L"1"),
           (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
           (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(
      ...
      (LPXLOPER12)TempStr12(L"xDupireCalib"),
      (LPXLOPER12)TempStr12(L"spot, vol, jumpIntensity, jumpAverage, jumpStd, "
                            L"spots, maxds, times, mxdt"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Calibrates Dupire"), (LPXLOPER12)TempStr12(L""));

  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL, (LPXLOPER12)TempStr12(L"xMerton"),
      (LPXLOPER12)TempStr12(L"BBBBBBBB"), (LPXLOPER12)TempStr12(L"xMerton"),
      (LPXLOPER12)TempStr12(L"spot, vol, mat, strike, intens, meanJmp, stdJmp"),
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Merton"), (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(
      ...
      (LPXLOPER12)TempStr12(L"1"), (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
      (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
      (LPXLOPER12)TempStr12(L"Barrier analytic"), (LPXLOPER12)TempStr12(L""));
  ...
  Excel12f(xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
           ...
           (LPXLOPER12)TempStr12(L"xToyDupireBarrierMc"),
           (LPXLOPER12)TempStr12(
               L"spot, spots, times, vols, mat, strike, barrier, paths, steps, "
               L"epsilon, useSobol, [seed1], [seed2]"),
           (LPXLOPER12)TempStr12(L"1"),
           (LPXLOPER12)TempStr12(L"myOwnCppFunctions"),
           (LPXLOPER12)TempStr12(L""), (LPXLOPER12)TempStr12(L""),
  ...
  Excel12f(
      xlfRegister, 0, 11, (LPXLOPER12)&xDLL,
      (LPXLOPER12)TempStr12(L"xSobolPoints"), (LPXLOPER12)TempStr12(L"QBBBB"),
