...
// dividend is applied end of day, that is, after everything else 	Prop
// divs don't affect BS implied surface
...
#include "mcMdl.h" // IWYU pragma: keep
...
public:
  void init(const vector<Time> &productTimeline,
    ...
    // matrix 	If Wi are independent standard Gaussians, then: 	Bi =
    // sum(CHOLij * Wj) 	are correlated standard Gaussians with the
    // correct correl
