...
private:
  ...
  void skipNumbers(const unsigned b) {
    ...
    static constexpr ullong m1l = static_cast<ullong>(m1);
    static constexpr ullong m2l = static_cast<ullong>(m2);
    ...
    unsigned long long Ab[3][3] = {{1, 0, 0}, {0, 1, 0}, {0, 0, 1}},
                       ...
                       Ai[3][3] =
                           {//  A0 = A
                            {
                                0, static_cast<ullong>(a12),
                                static_cast<ullong>(m1 - a13)
                       ...
                       Bi[3][3] = {//  B0 = B
                                   {
                                       static_cast<ullong>(a21), 0,
                                       static_cast<ullong>(m2 - a23)
                                       //	same logic: m2 - a32
                                   },
                                   {1, 0, 0},
                                   {0, 1, 0}};
    ...
    //  Final result
    unsigned long long X0[3] = {static_cast<ullong>(myXn),
                                static_cast<ullong>(myXn1),
                                static_cast<ullong>(myXn2)},
                       Y0[3] = {static_cast<ullong>(myYn),
                                static_cast<ullong>(myYn1),
                                static_cast<ullong>(myYn2)},
                       temp[3];
